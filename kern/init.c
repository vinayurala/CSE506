...
i386_init(void)
{
	...
	unsigned int num = 0x00646c72;
	cprintf("6828 decimal is %o octal!\n", 6828);
	cprintf("%c[%dm%c[%dm%c[%dmH%x %c[%dm%c[%dmWo%s %c[%dm%c[%dm\n", 0x1B, 44, 0x1B, 31, 0x1B, 1, 57616, 0x1B, 42, 0x1B, 33, &num, 0x1B, 30, 0x1B, 0);
...
// Lab 2 memory management initialization functions
	...
	// ENV_CREATE(fs_disk_crypt, ENV_TYPE_CRYPT);
